...
```c#
public static extern Cam.SmartContract.Framework.Services.Cam.Asset Create(byte asset_type, string name, long amount, byte precision, byte[] owner, byte[] admin, byte[] issuer)
```
