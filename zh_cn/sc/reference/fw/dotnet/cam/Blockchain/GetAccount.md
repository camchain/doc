...
```c#
public static extern Cam.SmartContract.Framework.Services.Cam.Account GetAccount(byte[] script_hash)
```
...
{
    byte[] scriptHash = Cam.Wallets.Wallet.ToScriptHash("AK4if54jXjSiJBs6jkfZjxAastauJtjjse").ToArray();
}
```
